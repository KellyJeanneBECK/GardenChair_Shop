...
final class UserController extends AbstractController
{
    ...
    public function changeRole(EntityManagerInterface $entityManager, User $user, $role): Response
    {
        ...
        if (!in_array($role, $validRoles, true)) {
            $this->addFlash('error', "The requested role is not valid.");
    ...
    public function deleteUser(User $user, EntityManagerInterface $entityManager, $id, UserRepository $userRepository): Response
    {
